...
for line2 in f2:
	...
	if movie_name in d:
		#print("found!")
		writemp = line2[:-16] + "\t" + d[movie_name]
		f_temp.write(writemp+"\n")
	else:
		f_temp.write(line2[:-16] + "\tNA"+"\n")
f2.close()
...
f_temp = open("./TSV/temp-after-actresses.tsv", "w")
for line2 in f2:
	row2 = line2.split("\t")
	movie_name = row2[1][1:-1]
	if movie_name in d:
...
####### Merge with Genra#########
file_name = "./LIST/genres.list.tsv"
...
f2 = open("./TSV/temp-after-actresses.tsv")
